...
IF( NOT DEFINED EUDAQ_DIR AND DEFINED EUDAQ_HOME )
    SET( EUDAQ_DIR "${EUDAQ_HOME}" )
ENDIF( NOT DEFINED EUDAQ_DIR AND DEFINED EUDAQ_HOME )

IF( NOT DEFINED EUDAQ_DIR AND DEFINED ENV{EUDAQ} )
    SET( EUDAQ_DIR "$ENV{EUDAQ}" )
ENDIF( NOT DEFINED EUDAQ_DIR AND DEFINED ENV{EUDAQ} )
...
FIND_PATH( EUDAQ_INCLUDE_DIRS NAMES eudaq/RunControl.hh PATHS ${EUDAQ_DIR}/main/include NO_DEFAULT_PATH )
